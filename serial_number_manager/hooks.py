...
doc_events = {
	"Delivery Note": {
		...
		"on_submit": [
			"serial_number_manager.serial_number_manager.overrides.delivery_note.add_serials_to_description_on_submit",
			"serial_number_manager.serial_number_manager.overrides.delivery_note.update_submitted_si_with_serials"
		]
	},
	"Sales Invoice": {
